            ...
            <div className="card col-md-6 offset-md-3 offset-md-3">
              ...
              <div className="card-body">
                <form>
                  ...
                  <button className='btn btn-success mt-4' onClick={updateHandler}>save</button>
                  <button className='btn btn-danger mt-4' onClick={cancelHandler} style={{marginLeft:"10px"}}>cancel</button>
                </form>
              </div>
            </div>
          </div>  
